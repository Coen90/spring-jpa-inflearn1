...
public class InitDb {
    ...
    static class InitService {
        ...
        public void dbInit1 () {
            Member member = createMember("userA", "seoul", "1", "22222");
            em.persist(member);
        ...
        private Member createMember(String namme, String city, String street, String zipcode) {
            Member member = new Member();
            member.setName(namme);
            member.setAddress(new Address(city, street, zipcode));
            return member;
        }

        public void dbInit2 () {
            Member member = createMember("userB", "Busan", "2", "33333");
            em.persist(member);
